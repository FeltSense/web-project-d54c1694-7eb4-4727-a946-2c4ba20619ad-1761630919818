...
export default function ContactForm() {
  ...
  <div className="mb-8">
    <h2 className="text-3xl font-bold text-gray-900 mb-2">Contact CloudSync Pro</h2>
    <p className="text-gray-600">Get in touch with our team. We'll respond within 24 hours.</p>
  </div>
