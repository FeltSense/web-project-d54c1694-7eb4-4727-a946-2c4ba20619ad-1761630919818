    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
        ...
        <p className="text-gray-700 mb-6 leading-relaxed">
          "CloudSync Pro has completely revolutionized our workflow. The real-time sync is flawless, and we've reduced file conflicts by 95%. Our remote team can now collaborate seamlessly across three continents."
        </p>
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
        ...
        <p className="text-gray-700 mb-6 leading-relaxed">
          "The security features are outstanding. End-to-end encryption gives us peace of mind when handling sensitive client data. Plus, the version control has saved us countless hours of work."
        </p>
        <div className="flex items-center">
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
        ...
        <p className="text-gray-700 mb-6 leading-relaxed">
          "We migrated from three different platforms to CloudSync Pro. The unlimited storage and lightning-fast upload speeds mean our design team can share large files instantly. Best decision we've made this year."
        </p>
        <div className="flex items-center">
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300 md:col-span-2 lg:col-span-1">
        ...
        <p className="text-gray-700 mb-6 leading-relaxed">
          "The customer support is phenomenal. When we needed help with enterprise deployment, their team was available 24/7. The intuitive interface meant our 200+ employees were up and running in days, not weeks."
        </p>
        <div className="flex items-center">
